...
//     col.g += abs(sin(length(uv - p) * (6. + sin(1. * 20.) * 0.01)) * 1.);
//     col.g *= sin(length(uv - p) * (6. + sin(1. * 20.) * 0.01));
vec2 newV = (uv + tan(uv.y * 3.)) - (p + -sin(uv.x * 0.1));
...
//     col -= InvCircleRGB(uv, p2, 0.8, 0.4, vec3(-1.0, -1.0, -1.0));
            col += CircleRGB(uv, p2, 0.4, 0.05, vec3(1.0, 0.4, 1.0));
//     col -= InvCircleRGB(uv, p2, 0.9, 0.3, vec3(1.0, 0.4, 1.0));   
...
//     col.r -= rando * 1.;
    ...
    col.r = 0.5 - col.r;
    col -= InvCircleRGB(uv, p2, 1.2, 0.7, vec3(0.5, 0.5, 0.0));
    col += CircleRGB(uv, p2, 0.7, 0.9, vec3(0.0, 0.4, 0.0));
//         col -= CircleRGB(uv, p2, 1.4, 0.2, vec3(-0.4, 0.1, 0.0));
...
//     col.r -= rando * 1.;
    ...
    col.r = 0.5 - col.r;
//     col -= InvCircleRGB(uv, p2, 1.2, 0.7, vec3(0.5, 0.5, 0.0));
    col += CircleRGB(uv, p2, 0.7, 0.9, vec3(-2., 0.2, 0.0));
//         col -= CircleRGB(uv, p2, 1.4, 0.2, vec3(0.8, 0.1, 0.0));
    col = vec3(1) - col;
    col += CircleRGB(uv, p2, 0.42, 0.1, vec3(2.0, 0.5, -4.0));
    gl_FragColor = vec4(col - rando, 1.0);
}
`);
...
//     col.r -= rando * 1.;
     col.g *= 0.2;
    col = vec3(1.) - col;
    col -= CircleRGB(uv, p2, 1.4, 0.3, vec3(1.0, 0.5, 0.0));
    col.r = 0.5 - col.r;
    col += CircleRGB(uv, p2, 0.4, 0.02, vec3(0.6, 0.2, -1.0));
//     col += CircleRGB(uv, p2, 0.4, 0.2, vec3(0.6, 0.2, -1.0));
    col += CircleRGB(uv, p2, 0.9, 0.9, vec3(0.6, 0.2, -1.0) * 0.5);
    gl_FragColor = vec4(col - rando, 1.0);
}
`);