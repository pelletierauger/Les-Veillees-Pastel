// beginGLSL
// ---------------------------------------------------------------------------- //
// rivière sourde, rosée, bleue, nuiteuse
// ---------------------------------------------------------------------------- //
setBothShaders(`
...
//     c = c - smoothstep(r * 0.5, r * 0.5 - 0.1, d);
    ...
    col.r += abs(sin(length(uv - p) * (6. + sin(1. * 20.) * 0.01)) * 5.);
...
//col += CircleRGB(uv, p2, 0.5, 0.1, vec3(0.2, 0.0, 0.8));
    ...
    col.r -= rando * 1.;
     col.g *= 0.5;
    col = vec3(1.) - col;
    col -= CircleRGB(uv, p2, 1.4, 0.2, vec3(0.0, 0.4, 1.0));
    gl_FragColor = vec4(col - rando, 1.0);
}
`);
...
//col += CircleRGB(uv, p2, 0.5, 0.1, vec3(0.2, 0.0, 0.8));
    ...
    col.r -= rando * 1.;
     col.g *= 0.5;
    col = vec3(1.) - col;
    col -= CircleRGB(uv, p2, 1.4, 0.2, vec3(0.0, 0.4, 0.0));
    gl_FragColor = vec4(col - rando, 1.0);
}
`);
