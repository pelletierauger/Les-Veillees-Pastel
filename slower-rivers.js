...
//     vec2 newV = (uv + tan(uv.x * 3.)) - (p + sin(uv));
    ...
    newV += sin(uv * 15. + (uv * 20.0)) * sin(t * 2000.);
    newV += sin(uv * 15. + (uv * 20.0)) * sin(t * 2000.);
    newV += sin(uv * 15. + (uv * 20.0)) * sin(t * 2000.);
    newV += sin(uv * 15. + (uv * 20.0)) * sin(t * 2000.);
...
//     vec2 newV = (uv + tan(uv.x * 3.)) - (p + sin(uv));
    ...
    newV += sin(uv * 0.001 + (uv * 20.0)) * sin(t * 200.);
    newV += sin(uv * 0.001 + (uv * 20.0)) * sin(t * 200.);
    newV += sin(uv * 0.001 + (uv * 20.0)) * sin(t * 200.);
    newV += sin(uv * 0.001 + (uv * 20.0)) * sin(t * 200.);
//  newV = cos(uv * 150. + cos(uv.x * 10. * (cos(time * 50.)) * uv.x)) * t * 0.1;
...
//     vec2 newV = (uv + tan(uv.x * 3.)) - (p + sin(uv));
    ...
    newV += sin(uv * 0.001 + (uv * 20.0)) * sin(t * 200.);
    newV += sin(uv * 0.001 + (uv * 20.0)) * sin(t * 200.);
//  newV = cos(uv * 0.1 + cos(uv.x * 100. * (cos(time * 5.)) * uv.x)) * 0.1;
//  newV *= sin(atan(newV.x * sin(t * 100.), newV.y * cos(t * 100.)));
    col *= cos(sin(atan(newV.x, newV.y) * (sin(t * 150.) * 0.75)) * 50.);
    col *= cos(cos(atan(newV.x, newV.y) * (sin(t * 150.) * 0.75)) * 50.);
//     col *= cos(cos(atan(newV.x, newV.y) * (sin(t * 150.) * 0.75)) * 50.);
//     col *= cos(cos(atan(newV.x, newV.y) * (sin(t * 150.) * 0.75)) * 50.);
...
//  col = max(col, 0.);
//  col += CircleRGB(uv, p2, 0.5, 0.1, vec3(0.2, 0.0, 0.8));
    col += CircleRGB(uv, p2, 1.14, 0.6, vec3(0.0, 0., 1.0));
    col += CircleRGB(uv, p2, 1.75, 0.6, vec3(1., 0.7, 0.0) * 0.75);
//  col += CircleRGB(uv, p2, 0.2, 0.02, vec3(-0.4, 0.4, -0.6));
//  col += CircleRGB(uv, p2, 0.5, 0.2, vec3(0.5, 0.7, 0.0));
//  col -= InvCircleRGB(uv, p2, 0.6, 0.2, vec3(1.5, 1.7, 1.0));
    float rando = rand(uvf) * 0.1;
...
//     uv *= 0.45;
    ...
    vec2 p = vec2(3.0, 4.0);
    vec2 p2 = vec2(0.0, 0.0);
    vec3 col = CircleRGB(uv, p2, 1.9, 0.2, vec3(0., 0.7, 1.0));
//     col.r *= sin(length(uv - p));
//     col.r += abs(sin(length(uv - p) * (0.1 + sin(1. * 2.) * 0.001)) * 5.) * 0.25;
//  col.g *= sin(length(uv - p) * (6. + sin(1. * 20.) * 0.01));
...
//     vec2 newV = (uv + tan(uv.x * 3.)) - (p + sin(uv));
    ...
    vec2 newV = pow(uv.x, -1.5) * (uv + sin(uv.y * 3.0)) - (p + sin(uv.y * 10.));
    uv = vec2(sin(uv.x * sin(t * 100.) * 10.), cos((uv.y + 0.58) * sin(t * 100.) * 10.));
//     uv.x *= 0.25;
    newV -= sin(uv * 0.01 + (uv * sin(t * 1090.) * 10.)) * t * sin(t * 2000.);
...
//  col = max(col, 0.);
//  col += CircleRGB(uv, p2, 0.5, 0.1, vec3(0.2, 0.0, 0.8));
    col += CircleRGB(uv, p2, 1.14, 0.6, vec3(0.5, 0.5, 0.0));
    col += CircleRGB(uv, p2, 1.75, 0.6, vec3(0.75, 0.4, 1.0) * 0.75);
//  col += CircleRGB(uv, p2, 0.2, 0.02, vec3(-0.4, 0.4, -0.6));
//  col += CircleRGB(uv, p2, 0.5, 0.2, vec3(0.5, 0.7, 0.0));
//  col -= InvCircleRGB(uv, p2, 0.9, abs(sin(t * 100.) * 10.), vec3(1.5, 1.7, 1.0));
    float rando = rand(uvf) * 0.1;
//  col.r -= rando * 1.;
//     col.g *= 0.5;
//  col += InvCircleRGB(uv, p2, 0.6, 0.2, vec3(0.5, 0.0, 0.3));
