...
//     c = c - smoothstep(r * 0.5, r * 0.5 - 0.1, d);
    ...
    vec2 p2 = vec2(2.1 * sin(t * 1.), 2.2 * cos(t * 10.)) * 0.4;
    vec2 p3 = vec2(0.1 * sin(t * 50.), 0.1 * cos(t * 5.)) * 0.4;
    float siz = sin(t * 100.);
    float siz2 = sin(t * 50.);
    p2 = vec2(0.0, 0.0);
...
//     col.g *= sin(length(uv - p) * (6. + sin(1. * 20.) * 0.01));
    ...
    newV += cos(sin(uv.y * pow(tan(t * 10.), uv.x) * 50.));
    newV += cos(sin(uv.x * pow(tan(t * 10.), uv.x) * 50.));
//     
//     lignes contours
...
//     col.g *= sin(length(uv - p) * (6. + sin(1. * 20.) * 0.01));
    vec2 newV = (uv + tan(uv.y * 3.)) - (p + sin(uv.x * 3.));
//     newV += cos(sin(uv.y * pow(tan(t * 100.), sin(t * 1.1) * 50. * uv.x) * 50.));
//     newV += cos(sin(uv.x * pow(tan(t * 100.), sin(t * 1.1) * 50. * uv.x) * 50.));
//     
//     lignes contours
//     newV.x *= cos(uv.y * sin(t * 100.) * 100.) * 100.;
//     
